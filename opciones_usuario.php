                                    ...
                                    <nav>
                                        <ul>
                                            <div id="load_img">
                                                ...
                                                <li><a href="menu_seleccion_usuarios" class ="menu-seleted"><i class="fas fa-undo-alt" title ="Volver"></i></a></li>
                    ...
                    <div class="container-box">
                        ...
                        <div class="box box1">
                            <img src="assets/imagenes/opciones-usuario/recuperar-sistema.svg" alt ="" title="Selecione el check para ir">
                                ...
                                <p>El sistema CRservices enviara una contraseña provicional a su email luego debera cambiarla por seguridad..</p>
                                </div>
                        ...
                        <div class="box box2">
                            <img src="assets/imagenes/opciones-usuario/cambiar_contrasena.svg" alt="" title="Selecione el check para ir">
                               ...
                               <div class="container-p">
                                ...
                                <div class="check">
                                    <a href="cambiar_contrasena?id=<?php echo $row['id'];?>" class="fas fa-check"></a>
                                </div>
                        </div>
                        ...
                        <!-- <div class="box box4">
                            <img src="assets/imagenes/opciones-usuario/agregar-usuario.svg" alt="" title="Selecione el check para ir">
                                ...
                                <div class="check">
                                 <a href="registrar_usuarios.php" class="fas fa-check"></a>
                                </div>
                        </div> -->
                        ...
                        <!-- <div class="box box6">
                                <img src="assets/imagenes/opciones-usuario/editar-usuarios.svg" alt="" title="Selecione el check para ir">
                                    ...
                                    <div class="check">
                                     <a href="editar_usuarios.php?id=<?php echo $row['id'];?>" class="fas fa-check"></a>
                                    </div>
                        </div> -->
