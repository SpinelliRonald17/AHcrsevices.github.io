    ...
    <body>
            <div class="wrapper fadeInDown">
                <div id="formContent">
                    ...
                    <h2 class="active"> Recuperar Contraseña (Sistema) </h2>
                          ...
                          try{
                                if(isset($_POST['email']) && !empty($_POST['email'])){
                                    ...
                                    try {
                                        ...
                                        $mail->Subject = 'Cambio de clave provisional (Sistema)'; 
                                        $mail->Body    = 'La contraseña de su cuenta de AHservices ha cambiado por una provicional ---><b>AH11069326081213032020</b><---
                                        <br>
                                        ...
                                        $mail->AltBody = 'La contraseña de su cuenta de AHservices ha cambiado por una provicional ---><b>AH11069326081213032020</br><---
                                        <br>
                                        Si no ha actualizado su cuenta, comuníquese inmediatamente, Envíando una solicitud de ayuda al correo electrónico a <b>crservices.soporte@gmail.com</b>
                                        <br>
                                        Si tiene problemas para acceder a su cuenta, restablezca la contraseña nuevamente.
                                        ...
                                        position: "center",
                                        icon: "success",
                                        title: "!Usted ha solicitado una clave provicional, se envio un email por segurida..!",
                                        showConfirmButton: true,
                                        confirmButtonText: "Aceptar"
